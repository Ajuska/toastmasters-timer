...
export class TimerControlsComponent {
  @Input() userMinutes: number | undefined | string = undefined;
  ...
  @Output() userMinutesChange = new EventEmitter<number | undefined | string>();
  ...
  onUserMinutesChange(value: string) {
    const normalizedValue = value.replace(',', '.');
    this.userMinutesChange.emit(normalizedValue);
